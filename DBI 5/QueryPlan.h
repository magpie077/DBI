...
class UnaryNode: protected QueryNode {
  friend class QueryPlan;
protected:
  UnaryNode(const std::string& op_Name, Schema* out, QueryNode* c, Statistics* st);
...
class BinaryNode: protected QueryNode {  // not including set operations.
  friend class QueryPlan;
protected:
  BinaryNode(const std::string& op_Name, QueryNode* l, QueryNode* r, Statistics* st);
